...
function AboutMe() {
  return (
    <section id= "about_me" className="min-h-screen bg-white py-10 px-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                  ...
                  <p className="leading-relaxed text-lg text-gray-700 flex-1">
                      ...
                      focus on data analytics, machine learning, software enginearing and deploying AI solutions at scale. 
